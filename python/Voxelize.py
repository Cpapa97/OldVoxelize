...
class VoxelMesh:
    def __init__(self, vertices, triangles=None, voxels=None, segment_id=None, exclude_isolated_vertices=False):
        ...
        :param triangles: Triangle/faces that each reference 3 vertices by index.
        ...
        :param exclude_isolated_vertices: Optional flag which requires the triangle/face data to exclude vertices not referenced by the triangles.
        """
    ...
    def exclude_isolated_vertices(self):
        """
        Optional flag which requires the triangle/face data to exclude vertices not referenced by the triangles.
        """
